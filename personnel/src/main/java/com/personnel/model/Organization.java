...
public class Organization implements Serializable {
    ...
    //两个分中心取号叫号关联中心的部门编号
    @Column(length = 255)
    @ApiModelProperty(value="中心组织关联编号，长度最大255",name="copyOrganNo")
