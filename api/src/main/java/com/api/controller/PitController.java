...
import com.api.service.PitService;
...
public class PitController {
    @Autowired
    private PitService meetingService;


    /**获取今天所有的会议*/
    @GetMapping("/getTodayMeeting")
    public ResponseResult getTodayMeeting(HttpServletRequest request){
        ...
        List<MeetingApply> meetingApply=meetingService.getAllTodayMeetingByIp(ip);
