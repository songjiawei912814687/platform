...
public class OrganizationOutput extends Organization {
    ...
    private String attendanceRuleValue;
    ...
    public String getAttendanceRuleValue() {
        return attendanceRuleValue;
    }

    public void setAttendanceRuleValue(String attendanceRuleValue) {
        this.attendanceRuleValue = attendanceRuleValue;
    }
