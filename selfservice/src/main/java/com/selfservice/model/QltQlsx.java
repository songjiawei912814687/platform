...
public class QltQlsx implements Serializable {
    ...
    private String businessRegulate;//审查业务规范

    private String chargeitemInfo;//收费标准
    ...
    public void setOutFlowUrl(String outFlowUrl) {
        this.outFlowUrl = outFlowUrl == null ? null : outFlowUrl.trim();
    }
    ...
    public void setHangYeClassType(String hangYeClassType) {
        this.hangYeClassType = hangYeClassType == null ? null : hangYeClassType.trim();
    }
    ...
    public String getWindowApplication() {
        return windowApplication;
    }

    public void setWindowApplication(String windowApplication) {
