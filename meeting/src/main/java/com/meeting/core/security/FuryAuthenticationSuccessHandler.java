package com.meeting.core.security;

import com.common.response.ResponseResult;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.meeting.config.RedisComponent;
import com.meeting.domain.output.ActionOutput;
import com.meeting.domain.output.LoginOutput;
...
import com.meeting.service.ActionService;
...
public class FuryAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private Map<String, List<String>> getActionOutput(List<ActionOutput> actions) {
        ...
        List<Action> action = actions.stream().filter(Action -> Action.getCode().indexOf("A_MEETING") >= 0).collect(toList());
