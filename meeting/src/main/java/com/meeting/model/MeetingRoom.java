...
public class MeetingRoom implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "meetingRoomGenerator")
    @SequenceGenerator(name = "meetingRoomGenerator",sequenceName = "meetingRoomNew_sequence",allocationSize = 1,initialValue = 1)
    @Column(length = 6)
    private Integer id;
