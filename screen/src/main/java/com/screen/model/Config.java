...
public class Config {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "configGenerator")
    @SequenceGenerator(name = "configGenerator", sequenceName = "config_sequence", allocationSize = 1, initialValue = 1)
    private Integer id;
