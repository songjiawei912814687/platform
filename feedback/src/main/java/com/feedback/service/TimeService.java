...
import com.feedback.mapper.mybatis.HolidayMapper;
import com.feedback.util.FeedbackHolidayUtils;
...
//        List<LinkedHashMap> list = (List<LinkedHashMap> )responseResult.getData();
        ...
        return  FeedbackHolidayUtils.getWorkDays(date, holidayList, workDayList, days);
    }
}
